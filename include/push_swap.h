...
void				reach_top_a(t_stack **stack_a, t_stack **stack_b,
						t_stack **best_count);
void				reach_top_b(t_stack **stack_a, t_stack **stack_b,
						t_stack **best_count);
// Algo
	// Find correspondants
...
t_stack				*find_the_correspondant_a(t_stack *initial_nb,
						t_stack *stack_to_find);
t_stack				*find_the_correspondant_b(t_stack *initial_nb,
						t_stack *stack_to_find);
	// Compute count
